...
Xwindow::Xwindow(int width, int height) {
  ...
  char color_vals[numColours][11] = {"white", "yellow", "black", "red", "green",
		"blue", "cyan", "magenta", "orange", "brown", "lime"};
...
void Xwindow::clearRectangle(int x, int y, int width, int height){
